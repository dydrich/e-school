<nav id="navigation">
	<div id="head_label">
		...
		<!-- <i class="fa fa-bars " id="open_drawer" style="float: left; position: relative; top: 18px; font-size: 1.2em"></i>-->
	...
	<div class="nav_div" style="float: right; margin-right: 50px; position: relative; top: 20px; text-align: right">Area amministrazione::<span id="navlabel"><?php echo $navigation_label ?></span></div>
