...
$sel_classes = "SELECT id_classe, anno_corso, sezione, nome FROM rb_classi, rb_sedi WHERE sede = id_sede AND ordine_di_scuola = {$school_order} ORDER BY sezione, anno_corso ";
