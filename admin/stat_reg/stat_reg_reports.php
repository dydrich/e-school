...
$sel_cls = "SELECT id_classe, anno_corso, sezione, ordine_di_scuola, rb_sedi.nome FROM {$classes_table}, rb_sedi, rb_tipologia_scuola WHERE sede = rb_sedi.id_sede AND ordine_di_scuola = id_tipo AND rb_tipologia_scuola.attivo = 1 ORDER BY sezione, anno_corso, sede ";
