...
$active = $res_active->fetch_assoc();
$drawer_label = "Segnalazione insufficienze mese di {$months[$active['mese']]}";
...
$sel_voti = "SELECT materia, alunno FROM rb_segnalazioni_pagellino WHERE id_pagellino = {$active['id_pagellino']} AND classe = {$_SESSION['__classe__']->get_ID()} ORDER BY alunno, materia ";
try{
...
include "segnalazioni_classe.html.php";
