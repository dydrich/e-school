...
<div id="main" style="clear: both; ">
	...
	<div style="width: 85%; margin: 30px auto">
		<a href='archivio_scrutini.php?y=<?php echo $idc2 ?>&sel=2' style='text-transform: uppercase; '>
			<div class='nowcard'>
		...
		<a href='archivio_scrutini.php?y=<?php echo $idc1 ?>&sel=1' style='text-transform: uppercase; color: '>
			<div class='nowcard'>
...
<div id="drawer" class="drawer" style="display: none; position: absolute">
	<div style="width: 100%; height: 430px">
		...
		<div class="drawer_link submenu">
			<a href="../registro_personale/scrutini.php?q=<?php echo $q ?>"><img src="../../../images/34.png" style="margin-right: 10px; position: relative; top: 5%"/>Scrutini</a>
		</div>
		<?php if($_SESSION['__user__']->isCoordinator($_SESSION['__classe__']->get_ID()) || $_SESSION['__user__']->getUsername() == 'rbachis') { ?>
			<div class="drawer_link submenu separator">
				<a href="../registro_personale/scrutini_classe.php?q=<?php echo $q ?>"><img src="../../../images/74.png" style="margin-right: 10px; position: relative; top: 5%"/>Scrutini classe</a>
			</div>
		<?php
		}
		?>
		...
		<div class="drawer_link submenu separator"><a href="classe.php"><img src="../../../images/14.png" style="margin-right: 10px; position: relative; top: 5%" />Gestione classe</a></div>
...
<div id="other_drawer" class="drawer" style="height: 144px; display: none; position: absolute">
	...
	<?php if ($ordine_scuola == 1): ?>
		<div class="drawer_link">
			<a href="../registro_personale/absences.php"><img src="../../../images/52.png" style="margin-right: 10px; position: relative; top: 5%"/>Assenze</a>
		</div>
	<?php endif; ?>
	<div class="drawer_link">
		<a href="../registro_personale/tests.php"><img src="../../../images/79.png" style="margin-right: 10px; position: relative; top: 5%"/>Verifiche</a>
	</div>
	<div class="drawer_link">
		<a href="../registro_personale/lessons.php"><img src="../../../images/62.png" style="margin-right: 10px; position: relative; top: 5%"/>Lezioni</a>
	</div>
	<?php
	}
	else { ?>
		<div class="drawer_link separator">
			<a href="../registro_personale/scrutini_classe.php?q=<?php echo $_q ?>"><img src="../../../images/34.png" style="margin-right: 10px; position: relative; top: 5%"/>Scrutini</a>
		</div>
	<?php } ?>
</div>
</body>
