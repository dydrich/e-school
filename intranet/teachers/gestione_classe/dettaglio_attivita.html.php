	...
	<div id="left_col">
		...
		<tr>
			...
			<td style="width: 80%">
				...
				<input type="text" value="<?php if($upd == 1) print substr($oi, 0, 5) ?>" style="width: 70px; float:right; margin-right: 4px; padding-top: 3px" name="ora_inizio" id="ora_inizio" />&nbsp;
			</td>
		</tr>
		<tr>
			...
			<td style="width: 80%">
				...
				<input type="text" value="<?php if($upd == 1) print substr($of, 0, 5) ?>" style="width: 70px; float:right; margin-right: 4px; padding-top: 3px" name="ora_fine" id="ora_fine" />&nbsp;
			</td>
		</tr>
		<tr>
