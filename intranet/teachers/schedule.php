 ...
 */
$orario_doc = array();
$sel_orario = "SELECT rb_orario.*, rb_classi.anno_corso AS cl, rb_classi.sezione, rb_materie.materia AS mat FROM rb_orario, rb_materie, rb_classi WHERE rb_orario.classe = rb_classi.id_classe AND rb_orario.materia = rb_materie.id_materia AND docente = ".$_SESSION['__user__']->getUid()." AND anno = ".$_SESSION['__current_year__']->get_ID()." ORDER BY giorno, ora";
//print $sel_orario;
