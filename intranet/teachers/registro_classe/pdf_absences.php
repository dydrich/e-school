...
check_session();
check_permission(DOC_PERM|STD_PERM);
...
class MYPDF extends SchoolPDF {
	...
	function pageHeader($alunno, $num_assenze){
		$this->SetY(25.0);
        $this->SetFont('', 'B', 9);
	...
	public function pageBody($assenze, $author, $alunno, $num_assenze) {
    	...
    	$this->pageHeader($alunno, $num_assenze);
