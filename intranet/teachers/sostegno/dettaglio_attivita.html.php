...
<div id="main">
	...
	<div id="left_col">
		...
		<form id="my_form" method="post" action="aggiorna_dati_nucleo.php" style="border: 1px solid #666666; border-radius: 10px; margin-top: 30px; text-align: left; width: 90%; margin-left: auto; margin-right: auto">
