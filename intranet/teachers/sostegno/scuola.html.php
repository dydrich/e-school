...
<div id="main">
	...
	<div id="left_col">
		<h2 style="text-align: center; padding-top: 10px">Scuola di provenienza</h2>
		<div id="not1" class="notification"></div>
		<form id="my_form" method="post" action="aggiorna_dati_nucleo.php" style="border: 1px solid #666666; border-radius: 10px; margin-top: 30px; text-align: left; width: 460px; margin-left: auto; margin-right: auto">
		<table style="width: 400px; margin-left: auto; margin-right: auto; margin-top: 30px; margin-bottom: 20px">
			<tr>
				<td style="width: 60%">Scuola</td>
				<td style="width: 40%"><input type="text" name="school" id="school" style="width: 250px; font-size: 11px; border: 1px solid #AAAAAA" value="<?php if ($_SESSION['__sp_student__']['dati']['scuola_provenienza']) echo $_SESSION['__sp_student__']['dati']['scuola_provenienza'] ?>" /></td> 
			</tr>
			<tr>
				<td style="width: 60%">Classe</td>
				<td style="width: 40%"><input type="text" name="class" id="class" style="width: 250px; font-size: 11px; border: 1px solid #AAAAAA" value="<?php if ($_SESSION['__sp_student__']['dati']['classe_provenienza']) echo $_SESSION['__sp_student__']['dati']['classe_provenienza'] ?>" /></td> 
			</tr>
			<tr>
				<td colspan="2">&nbsp;
