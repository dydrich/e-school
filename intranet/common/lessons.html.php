...
<p style="text-align: center; font-weight: bold; border: 1px solid rgb(211, 222, 199); outline-style: double; outline-color: rgb(211, 222, 199); background-color: rgba(211, 222, 199, 0.7); height: 15px"><?php print $giorno; if ($lday['assente']) echo "<span class='attention'> (assente)</span>" ?></p>
<?php
	if ($lday){
		foreach($lday['ore'] as $ac){
?>
<p style='border-bottom: 1px solid rgba(211, 222, 199, 0.6); height: 15px; padding-bottom: 2px; font-weight: bold'><?php echo $ac['ora']." ora - ".$materie[$ac['materia']].": "  ?><span style='font-weight: normal'><?php echo $ac['argomento'] ?></span></p>
