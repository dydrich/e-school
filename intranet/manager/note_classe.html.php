...
<head>
	...
	<title><?php print $_SESSION['__config__']['intestazione_scuola'] ?>:: note disciplinari di classe</title>
...
<div id="main">
	...
	<div id="left_col">
		<div class="card_container" style="margin-top: 20px">
			<?php
			while($nota = $res_note->fetch_assoc()){
				setlocale(LC_TIME, "it_IT.utf8");
				$date_string = strftime("%A %d %B", strtotime($nota['data']));
				?>
				<div class="card">
					<div class="card_title">
						<span class="_normal"><?php echo $nota['tipo_nota'] ?></span>
						<div class="fright">
							<span class="_normal"><?php echo $date_string ?></span>
						</div>
					</div>
