...
<div id="drawer" class="drawer" style="display: none; position: absolute">
	<div style="width: 100%; height: 430px">
		...
		<?php if(is_installed("wflow")){ ?>
            <div class="drawer_link"><a href="<?php echo $_SESSION['__path_to_root__'] ?>modules/workflow/load_module.php?module=wflow&area=<?php echo $_SESSION['__area__'] ?>"><img src="../../images/73.png" style="margin-right: 10px; position: relative; top: 5%" />Gestione segreteria</a></div>
		<?php } ?>
