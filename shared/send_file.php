...
<body>
<form action="send_file.php?action=upload" method="post" enctype="multipart/form-data" id="doc_form">
...
<span style="font-weight: normal; color: red; font-size: 11px; display: <?php echo $display ?>" id="_span">Attendere la copia del file...</span>
...
if($_REQUEST['action'] == "upload"){
	 ...
	 */
	$dir = $_SESSION['__config__']['html_root']."/download/didattica/".$_SESSION['__user__']->getUid();
